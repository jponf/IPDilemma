...
/**
 * Uses the action that the other player has used more, or random if both
 * are used the same amount of times
 */
public class MoreUsedStrategy implements PlayerStrategy {
    ...
    /**
     * Builds a new MoreUsedStrategy instance with all the counters
     * initialized to 0
     */
	...
	/**
	 * Increase the internal counter of how much times an action have been
	 * taken by the rival
	...
	public boolean equals(Object obj) {
		...
		if (this.random_strategy.equals(other.random_strategy) &&
				this.ncooperations == other.ncooperations &&
				this.ndefections == other.ndefections) {
			return true;
		}
